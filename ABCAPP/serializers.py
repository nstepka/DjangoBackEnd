...
class Storage_typeSerializer(serializers.ModelSerializer):
    class Meta:
        model = StorageType
        fields = ('storage_type_id', 'type_name', 'created_by', 'created_date', 'modified_by', 'modified_date', 'is_deleted')


class Inventory_typeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Inventory
        fields = ('inventory_id', 'abc_client_id', 'inventory_name', 'storage_type_id', 'max_item_capacity', 'address', 'created_by', 'created_date',
                 'modified_by', 'modified_date', 'is_deleted')
...
class access_logSerializer(serializers.ModelSerializer):
    class Meta:
        model = AccessLog
        fields = ('access_log_id', 'username', 'resource_type_id', 'action', 'table_name', 'field_name', 'screen_name', 'created_date')
